...
name<-"series" # the series identifier, only lowercases and numbers (must start with a letter)
...
description<-"My series" # The series name
...
category<-"Series with revision" # Specifying the category of the series
